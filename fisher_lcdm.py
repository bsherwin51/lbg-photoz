...
def fiducial_model(theta):
    ...
    cosmo = MainCosmology(Omega_M=Omega_M, sigma8 = sigma8, Omega_b = Omega_b, h = h, n_s = n_s)
...
if __name__ == "__main__":
    ...
    theta0 = np.array([0.3156, 0.831, 0.0491685, 0.6727, 0.9645, 2.1574085950258355, 3.3278572844505083, 4.858283802099753, 1.49, 1.69, 1.79])  
    cosmo = MainCosmology(Omega_M=theta0[0], sigma8=theta0[1], Omega_b=theta0[2], h=theta0[3], n_s=theta0[4])
